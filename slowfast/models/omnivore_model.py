...
def omnivore_swinB_imagenet21k_288(
    progress: bool = True,
    checkpoint_name: str = "omnivore_swinB_imagenet21k",
    **kwargs: Any,
) -> nn.Module:
    r"""
    Omnivore swin B model trained on EPIC-KITCHENS-100 dataset
    ...
    # Only specify the non default values
    trunk = SwinTransformer3D(
        pretrained=['/scratch/shared/beegfs/jaesung/pretrained/omnivore/swinB_In21k_checkpoint.torch'],
        pretrained2d=False,
        pretrained3d=(16, 7, 7),
        patch_size=(2, 4, 4),
        embed_dim=128,
...
def omnivore_swinB_imagenet21k_320(
    progress: bool = True,
    checkpoint_name: str = "omnivore_swinB_imagenet21k",
    **kwargs: Any,
) -> nn.Module:
